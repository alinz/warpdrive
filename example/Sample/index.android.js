...
export default class Sample extends Component {
  ...
  onCheck = () => {
    isAnyUpdate((release) => {
      if (release) {
        Alert.alert("Info", `an update ${release.version} is available, do you want to update?`, [
          { 
            text: 'Yes', 
            onPress: () => {
              update((err) => {
                ...
                Alert.alert('Info', 'update is completed', [
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text onPress={this.onCheck} style={styles.welcome}>
          What the fuck! 1.29
        </Text>
